...
interface __declspec(uuid("{7F017528-8110-4FB3-BE41-F472969C2560}")) IZoneWindow : public IUnknown
{
    ...
    IFACEMETHOD_(std::wstring, GetActiveZoneSetTmpPath)() = 0;
    IFACEMETHOD_(std::wstring, GetAppliedZoneSetTmpPath)() = 0;
    IFACEMETHOD_(std::wstring, GetCustomZoneSetsTmpPath)() = 0;
};
